        ...
        setContent {
            ...
            ManaVahanaTheme(themeMode = themeMode, darkTheme = isDarkTheme) {
                ...
                CompositionLocalProvider(com.manavahana.ui.LocalAppLanguage provides langCode) {
                    ...
                    // Handle Android system back press: close quick actions if open, otherwise finish activity to close app
                        ...
                        NavHost(
                            ...
                            composable("dashboard") {
                                DashboardScreen(
                                    ...
                                    onNavigateToVehicleDetails = { id ->
                                        navController.navigate("vehicle_details/$id") {
                                            popUpTo(0) { inclusive = true }
                                            launchSingleTop = true
                                        }
                                    },
                                    ...
                                    onNavigateToAddService = {
                                        navController.navigate("service_logs") {
                                            popUpTo(0) { inclusive = true }
                                            launchSingleTop = true
                                        }
                                    },
                                    onNavigateToAddFuel = {
                                        navController.navigate("fuel_logs") {
                                            popUpTo(0) { inclusive = true }
                                            launchSingleTop = true
                                        }
                                    },
                                    onNavigateToVault = {
                                        navController.navigate("document_vault") {
                                            popUpTo(0) { inclusive = true }
                                            launchSingleTop = true
                                        }
                                    }
                            ...
                            composable("add_vehicle") {
                                AddVehicleScreen(
                                    viewModel = viewModel,
                                    onNavigateBack = { this@MainActivity.finish() }
                                )
                            }
